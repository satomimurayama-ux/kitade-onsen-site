/**
 * 都道府県マスタ。
 * slug がURLの一部になります（例：/prefecture/hokkaido/）。
 * region（地方名）でグループ化して表示します。
 */
...
export const prefectures: Prefecture[] = [
  ...
  // 関西
  { slug: "mie", name: "三重県", region: "関西" },
  { slug: "shiga", name: "滋賀県", region: "関西" },
  { slug: "kyoto", name: "京都府", region: "関西" },
  { slug: "osaka", name: "大阪府", region: "関西" },
  { slug: "hyogo", name: "兵庫県", region: "関西" },
  { slug: "nara", name: "奈良県", region: "関西" },
  { slug: "wakayama", name: "和歌山県", region: "関西" },
  // 山陰・山陽
  { slug: "tottori", name: "鳥取県", region: "山陰・山陽" },
  { slug: "shimane", name: "島根県", region: "山陰・山陽" },
  { slug: "okayama", name: "岡山県", region: "山陰・山陽" },
  { slug: "hiroshima", name: "広島県", region: "山陰・山陽" },
  { slug: "yamaguchi", name: "山口県", region: "山陰・山陽" },
  // 四国
